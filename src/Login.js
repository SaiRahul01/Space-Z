import { View, Text, StyleSheet,TextInput, TouchableOpacity, ToastAndroid,AsyncStorage, Alert } from 'react-native'
...
const Login = (props) => {
  ...
  return (
    <View style={ss.root}>
      ...
      <Text style={{color:'white'}}>{passkey}</Text>
      </View>
      ...
      <View style={{marginLeft:30,marginRight:30,marginTop:50,padding:10,flexDirection:'row',justifyContent:'space-around',alignItems:'center'}}>
        ...
        <TextInput placeholder='Enter Key' placeholderTextColor={'white'} style={{borderWidth:0,borderColor:'white',padding:15,backgroundColor:'#5F939A',height:50,color:'white'}} value={passkey} onChangeText={setpasskey}  selectionColor='white' secureTextEntry={true}/>
        </View>
